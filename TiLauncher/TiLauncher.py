...
def Help():
    ...
    StartL() - Она запускает Лаунчер Майнкрафта (Скачается версия майнкрафта в папку C:\\Users\\Ваш пользователь\\AppData\\Roaming\\.TiLauncher (Если этой версии нету)),
    StartC() - Она запускает консольную версию Лаунчера Майнкрафт (Скачается версия майнкрафта в папку C:\\Users\\Ваш пользователь\\AppData\\Roaming\\.TiLauncher (Если этой версии нету))""")
